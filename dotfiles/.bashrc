...
# COLOR
COLOR_PURPOSE_USER_CURRENT_STATE='\[\033[01;36m\]'
COLOR_PURPOSE_IDENTIFIER='\[\033[01;34m\]'
COLOR_RESET='\[\033[0m\]'
...
# RENDER
export PS1="$NEWLINE${COLOR_PURPOSE_IDENTIFIER}$WORKING_DIRECTORY${COLOR_PURPOSE_USER_CURRENT_STATE}$GIT_BRANCH$NEWLINE$PROMPT_SYMBOL${COLOR_RESET} "

...
# RENDER
export PS1="$NEWLINE${COLOR_PURPOSE_IDENTIFIER}$WORKING_DIRECTORY${COLOR_RESET}${COLOR_PURPOSE_USER_CURRENT_STATE}$GIT_BRANCH${COLOR_RESET}$NEWLINE${COLOR_PURPOSE_IDENTIFIER}$PROMPT_SYMBOL${COLOR_RESET} "
